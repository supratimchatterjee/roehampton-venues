...
<!-- Page banner -->
	...
	<?php while ( have_posts() ) : the_post(); ?>
			...
			<div class="uk-block intro-block" <?php if (!empty($bg_img)){?>style="background-size:cover; background-image: url(<?php echo $bg_img; ?>); background-color:#253746; "<?php }?>>
		...
		<div class="uk-block">
			<div class="uk-container uk-container-center">
				<div class="uk-grid uk-grid-match" data-uk-grid-match="{target:'figcaption p'}">
				
					<?php $terms = get_field('event_places');?>
					<?php $i=1;?>
					<?php foreach($terms as $term) :?>
						<div class="uk-width-small-1-3 uk-width-medium-1-3 uk-width-large-1-3 uk-width-1-1 venue-type-<?php echo $i;?>">
							<figure>
							
							<?php $term_id = $term->term_id;?>
							<?php $tax_thumb = get_field ('tax_image','place_'.$term_id);?>
							
							<?php if($tax_thumb):?>
								<img src="<?php echo $tax_thumb;?>">
							<?php else:?>
								<img src="http://placehold.it/308x200">
							<?php endif;?>							
